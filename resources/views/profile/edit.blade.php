...
<div class="profile-edit-container">
    <div class="profile-edit-header">
        ...
        <h2 class="gradient-text">Edit Profile</h2>
    </div>

    {{-- Shared container for form + danger zone --}}
    <div class="profile-edit-form-wrapper animate-slide-up">
        ...
        <div class="danger-zone">
            ...
            <form action="{{ route('profile.destroy') }}" method="POST" class="delete-form" onsubmit="return confirm('Are you absolutely sure you want to delete your account? This action cannot be undone.');">
                @csrf
                @method('DELETE')
